"""Simulator-independent tests for the minimal Phase-1 I1 provider card."""
...
def run_all_tests() -> None:
    ...
    # rho=1-.05/3.  This is precisely why rho must be a dimension of I1.
    ...
    print("PHASE1_I1_PROVIDER_CARD_TESTS_PASS")
